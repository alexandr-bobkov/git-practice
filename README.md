...
* **Ответ:** У коммита **2 родителя** (это коммит слияния / merge commit).
* **Хеши родителей:**
...
* **Коммит создания:** `5ac311e2a9` (*main: synchronize writes to VT100-faker on Windows*)
